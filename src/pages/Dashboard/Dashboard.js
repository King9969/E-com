...
import { data, data2, data3, labels } from "./Data";
import {
  Chart as ChartJS,
  LinearScale,
  CategoryScale,
  ...
  return (
    <>
      <div className=" p-24 max-md:p-0 max-md:py-28 overflow-hidden">
        ...
        <h1 className="p-20 text-4xl font-semibold text-gray-800 text-center">
          Sales Report
        </h1>
        <div className=" lg:flex lg:h-72  justify-between  ">
          <Component />
...
function Component() {
  return (
    <div class="relative w-full px-4 py-6 lg:mx-5 bg-white shadow-lg dark:bg-gray-900 rounded-xl">
      ...
      <div className="   px-4 pb-24 overflow-auto md:px-6">
        ...
        <div className="flex  flex-col items-center w-full my-6 space-y-4 md:space-x-4 md:space-y-0 md:flex-row">
          <div className="w-full  md:w-6/12">
            <div className="relative rounded-xl  w-full overflow-hidden bg-white shadow-lg dark:bg-gray-900">
              <a href="#" className="block w-full h-full">
                <div className="flex  items-center justify-between px-4 py-6 space-x-4">
                  <div className="flex  items-center">
                    <span className=" relative p-5 bg-blue-600 rounded-full">
                      <svg
                        width="40"
                        fill="currentColor"
                        height="40"
                        className="absolute h-5 text-gray-100 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                        viewBox="0 0 1792 1792"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                    ...
                    <p className="ml-2 text-sm font-semibold text-gray-900 border-b border-gray-200 dark:text-white">
                      Level 2 Ambassador
                    </p>
                  </div>
                ...
                <div className="w-full h-3 bg-gray-100">
                  <div className="w-2/5 h-full text-xs text-center text-white bg-blue-600"></div>
                </div>
              </a>
            </div>
          </div>
          <div className="flex items-center  w-full space-x-4 md:w-1/2">
            <div className="w-1/2 ">
              <div className=" rounded-xl  relative w-full px-4 py-6 bg-white shadow-lg dark:bg-gray-900">
            ...
            <div className="w-1/2">
              <div className=" rounded-xl relative w-full px-4 py-6 bg-gray-900">
                <p className="text-2xl font-bold text-black dark:text-white">
                  $93.76
                </p>
                <p className="text-sm text-gray-400">Commission in approval</p>
                <span className="absolute p-4 bg-blue-600 rounded-full top-2 right-4">
                  <svg
                    width="40"
                    fill="currentColor"
                    height="40"
...
function Transaction() {
  return (
    <div class="relative w-full p-4 overflow-hidden bg-white shadow-lg mx-auto rounded-xl md:w-80 dark:bg-gray-900">
      <div class="flex items-center justify-between w-full mb-8">
        <p class="text-xl text-gray-800 dark:text-white">Account</p>
        <a
          href="#"
          class="flex items-center text-sm text-gray-300 border-0 hover:text-gray-600 dark:text-gray-50 dark:hover:text-white focus:outline-none"
        >
          VIEW ALL
        </a>
      </div>
