...
export default function Checkout() {
  ...
  window.scrollTo(0, 0);
  return (
    <div className="overflow-y-hidden py-20 max-lg:py-20">
      <div className="flex justify-center items-center 2xl:container 2xl:mx-auto lg:py-16 md:py-12 py-9 px-4 md:px-6 lg:px-20 xl:px-44 ">
        <div className="flex w-full sm:w-9/12 lg:w-full flex-col lg:flex-row justify-center items-center lg:space-x-10 2xl:space-x-36 space-y-12 lg:space-y-0">
          <div className="flex w-full  flex-col justify-start items-start">
            ...
            <button className=" rounded focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 mt-8 text-base font-medium focus:ring-2 focus:ring-ocus:ring-gray-800 leading-4 hover:bg-black py-4 w-full md:w-4/12 lg:w-full text-white bg-blue-600">
              Proceed to payment
            </button>
            <div className="mt-4 flex justify-start items-center w-full"></div>
          </div>
          <div className=" rounded flex flex-col justify-start items-start bg-gray-50 w-full p-6 md:p-14">
            <div>
